...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
    <head>
        ...
        <!--===============================================================================================-->
        <link rel="stylesheet" media="screen, print" href="${pageContext.request.contextPath}/resources/css/smart/fa-brands.css">
        <!--===============================================================================================-->
                        ...
                        <div class="d-flex align-items-center container p-0">
                            <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                                <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                    ...
                                    <span class="page-logo-text mr-1">SQI Soft</span>
                                </a>
                            </div>                            
                        </div>
                    </div>
                    <div class="flex-1" style="background: url(${pageContext.request.contextPath}/resources/assets/smart/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                        <div class="container py-4 py-lg-5 my-lg-5 px-4 px-sm-0">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                                    <h1 class="text-white fw-300 mb-3 d-sm-block d-md-none">로그인</h1>
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form name="loginForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="userId" name="userId" class="form-control form-control-lg" placeholder="아이디 또는 이메일" value="" required>
                                                <div class="invalid-feedback">No, you missed this one.</div>
                                                <div class="help-block"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="password">비밀번호</label>
                                                <input type="password" id="password" name="password" class="form-control form-control-lg" placeholder="비밀번호" value="" required>
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-6 pl-lg-1 my-2">
                                                    <button id="js-login-btn" type="button" class="btn btn-danger btn-block btn-lg">로그인</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="position-absolute pos-bottom pos-left pos-right p-3 text-center text-white">
                                2020 © base system by&nbsp;<a href='https://www.gotbootstrap.com' class='text-white opacity-40 fw-500' title='gotbootstrap.com' target='_blank'>gotbootstrap.com</a>
                            </div>
                        </div>
                    </div>
                </div>
