...
<ol class="breadcrumb bg-transparent border border-primary">
	<li class="breadcrumb-item text-primary"><a class="text-primary" href="#"> <i class="fal fa-chart-line mr-1 fs-md"></i> 통계</a></li>	
</ol>
		...
		<div class="row">
			...
			<div class="col-xs-3 p-1">
				<div class="input-group">
					...
					<input class="form-control" id="start-date" type="date" name="date" value="2023-07-23">	
					<span class="align-self-center ml-1 mr-1" id="split-date">~</span> 
					<input class="form-control" id="end-date" type="date" name="date" value="2023-07-23">				
				</div>
			</div>
			<div class="col-xs-3 p-1">
...
<script>
	...
	function searchTypeChange(){		
		...
		if (searchType == "hour"){
			...
			$('#end-date').val(getDate(0));
			
			$("#datatable-hour").show();
					
		}else if(searchType == "day"){
			
			$('#start-date').val(getDate(-6));
			$('#end-date').val(getDate(0));
